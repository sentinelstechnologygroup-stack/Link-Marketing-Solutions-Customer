...
export default function Security() {
  ...
  if (!data) return <div><PageHeader title="Security" description="Manage authentication, sessions, devices, and security events." /><SectionCard title="Security settings"><EmptyState title="Security profile is being configured" description="Your sign-in is active. MFA, trusted devices, and detailed security history will appear after the security profile is configured." /></SectionCard></div>;
