export default function Logo({ variant = "dark", size = 30, showWord = true, className = "" }) {
  ...
  return (
    <div
      className={`inline-flex max-w-full items-center overflow-hidden rounded-lg border border-[#d8c9a2]/70 bg-white shadow-sm ${variant === "light" ? "shadow-black/20" : ""} ${className}`}
